...
#include "stanExports_rubin_normal2.h"

RCPP_MODULE(stan_fit4rubin_normal2_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_rubin_normal2")
